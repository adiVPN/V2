...
echo -e "         Author : ${green}Sanzz Tunnel  ${NC}${YELLOW}(${NC} ${green}Project ${NC}${YELLOW})${NC}"
...
data_ip="https://raw.githubusercontent.com/sanzVPN/regip/main/ip"
checking_sc() {
  ...
  if [[ $date_list < $useexp ]]; then
    ...
    echo -e "      \033[0;36mTelegram${NC} t.me/sanzSTORE"
...
# USERNAME
rm -f /usr/bin/user
username=$(curl https://raw.githubusercontent.com/sanzVPN/regip/main/ip | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
expx=$(curl https://raw.githubusercontent.com/sanzVPN/regip/main/ip | grep $MYIP | awk '{print $3}')
echo "$expx" >/usr/bin/e
# DETAIL ORDER
...
function notif_bot() {
    USRSC=$(curl https://raw.githubusercontent.com/sanzVPN/regip/main/ip | grep $ipsaya | awk '{print $2}')
    EXPSC=$(curl https://raw.githubusercontent.com/sanzVPN/regip/main/ip | grep $ipsaya | awk '{print $3}')
