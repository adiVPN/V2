...
echo -e "\033[33m# // Author: VPN RACING STORES\e[0m"
echo -e "\033[33m# // Description: Xray Menu Management\e[0m"
echo -e "\033[33m# // email: no\e[0m"
echo -e "\033[33m# // telegram: t.me/ADISTORES0\e[0m"
echo -e "\033[33m# //====================================\e[0m"
sleep 1
Green="\e[92;1m"
RED="\033[31m"
...
TIME="10"
CHATID="6134500139"
KEY="6899241287:AAE5rn7Kmvsl8d6AQWNocKJWP_epGv4QXdU"
...
LOGO() {
    ...
    echo -e " ───│    $Green├─┤│ │ │ │ │└─┐│  ├┬┘│├─┘ │   │  │ │ ├┤ $NC   │───"
    echo -e " ───│    $Green┴ ┴└─┘ ┴ └─┘└─┘└─┘┴└─┴┴   ┴   ┴─┘┴ ┴ └─┘$NC   │───"
    echo -e "    │    ${YELLOW}Copyright${FONT} (C)${GRAY}https://t.me/sanzStore$NC   │"
    echo -e "    └───────────────────────────────────────────────┘"
...
clear;clear;clear
  ...
  # // Banner
echo -e "${RED}─────────────────────────────────────────────────${NC}"
echo -e "  Welcome To Sanzz Script${YELLOW}(${NC}${green} Stable Edition ${NC}${YELLOW})${NC}"
echo -e "     This Will Quick Setup VPN Server On Your Server"
echo -e "         Author : ${green}Macro Tunnel  ${NC}${YELLOW}(${NC} ${green}Project ${NC}${YELLOW})${NC}"
echo -e "       © Recode By Sanzz ${YELLOW}(${NC} 2023 ${YELLOW})${NC}"
echo -e "${RED}─────────────────────────────────────────────────${NC}"
echo ""
sleep 4
###### IZIN SC 
...
data_ip="https://raw.githubusercontent.com/adiVPN/regip/main/ip"
checking_sc() {
  ...
  if [[ $date_list < $useexp ]]; then
    ...
    echo -e "      \033[0;36mTelegram${NC} t.me/adiSTORE"
    echo -e "      ${GREEN}WhatsApp${NC} wa.me/6282210884180"
    echo -e "\033[1;93m────────────────────────────────────────────\033[0m"
    exit
  fi
}
...
# USERNAME
rm -f /usr/bin/user
username=$(curl https://raw.githubusercontent.com/adiVPN/regip/main/ip | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
expx=$(curl https://raw.githubusercontent.com/adiVPN/regip/main/ip | grep $MYIP | awk '{print $3}')
echo "$expx" >/usr/bin/e
# DETAIL ORDER
...
Exp1=$(curl https://raw.githubusercontent.com/adiVPN/regip/main/ip | grep $MYIP | awk '{print $4}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/adiVPN/V2/main/"
...
function notif_bot() {
    USRSC=$(curl https://raw.githubusercontent.com/adiVPN/regip/main/ip | grep $ipsaya | awk '{print $2}')
    EXPSC=$(curl https://raw.githubusercontent.com/adiVPN/regip/main/ip | grep $ipsaya | awk '{print $3}')
